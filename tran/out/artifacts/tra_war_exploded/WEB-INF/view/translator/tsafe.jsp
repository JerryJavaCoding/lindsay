									...
									<div class="tab">
										<div class="tab-content">
											<div class="tab-content-inner active" data-content="signup">
												<c:forEach var="translator" items="${requestScope.translators}">
												<form action="/translator/dotsafe/${sessionScope.translator.Id}" method="post">

													<div class="col-md-12">
														<label for="tid">Translator Id</label>
														<input type="text" class="form-control" id="tid" name="translator.Id" readonly value="${translator.Id}">
													</div>
													<div class="col-md-12">
														<label for="password">Original Password</label>
														<input type="text" class="form-control" id="password"name="translator.tpwd" disabled  value="${translator.tpwd}">
													</div>
													<div class="col-md-12">
														<label for="tnewpwd">New Password</label>
														<input type="password" class="form-control" id="tnewpwd" name="translator.tpwd" >
													</div>
													<div class="col-md-12">
														<label for="trenewpwd">Repeat New Password</label>
														<input type="password" class="form-control" id="trenewpwd" >
													</div>
													<div class="col-md-12 mgt10">
														<div class="col-md-6 col-xs-6"><input type="submit" class="btn btn-primary" id="tsubmit" value="修改"></div>
