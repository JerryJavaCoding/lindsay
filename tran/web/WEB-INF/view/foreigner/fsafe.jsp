                  ...
                  <div class="tab">
                    <div class="tab-content">
                      <div class="tab-content-inner active" data-content="signup">
                        ...
                        <form action="/foreigner/updatefpwd/${sessionScope.foreigner.Id}" method="post">

                          <div class="col-md-12">
                            <label for="fid">Foreigner Id</label>
                            <input type="text" class="form-control" id="fid" name="foreigner.Id" readonly value="${foreigner.Id}">
                          </div>
                          <div class="col-md-12">
                            <label for="password">Original Password</label>
                            <input type="text" class="form-control" id="password"name="foreigner.fpwd" disabled  value="${foreigner.fpwd}">
                          </div>
                          <div class="col-md-12">
                            <label for="fnewpwd">New Password</label>
                            <input type="password" class="form-control" id="fnewpwd" name="foreigner.fpwd" >
                          </div>
                          <div class="col-md-12">
                            <label for="frenewpwd">Repeat New Password</label>
                            <input type="password" class="form-control" id="frenewpwd">
                          </div>
                          <div class="col-md-12 mgt10">
                            <div class="col-md-6 col-xs-6"><input type="submit" class="btn btn-primary" id="fsubmit" value="修改"></div>
