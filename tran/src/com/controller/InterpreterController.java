...
public class InterpreterController extends Controller {
    public void index(){
        ...
        List forders = Forder.dao.find("SELECT * FROM forder where Id = "+id+" and dealing='picked up'");
    ...
    public void business(){
        List forders = Forder.dao.find("SELECT * FROM forder where dealing='waiting'");
        setAttr("forders",forders);
