...
public class ForeignerController extends Controller {
    public void index(){
        ...
        List translators = Translator.dao.find("SELECT * FROM translator where Id =(SELECT trid FROM forder where Id = "+id+")");
    ...
    public void selectorder(){
        ...
        setAttr("forders",forders);
        List translators = Translator.dao.find("SELECT * FROM translator where Id =(SELECT trid FROM forder where Id = "+getParaToInt()+")");
        setAttr("translators",translators);
        render("myorder.jsp");
    }//查看订单
