                  ...
                  <div class="tab">
                    <div class="tab-content">
                      <div class="tab-content-inner active" data-content="signup">
                        ...
                        <form action="/admin/updateapwd" method="post">
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="password" class="form-control" id="password"name="admin.pwd" disabled  value="${admin.pwd}">
                          </div>
                          <div class="col-md-12">
                            <label for="newpwd">New Password</label>
                            <input type="password" class="form-control" id="newpwd" name="admin.pwd" >
                          </div>
                          <div class="col-md-12">
                            <label for="renewpwd">Repeat New Password</label>
                            <input type="password" class="form-control" id="renewpwd" name="admin.pwd" >
                          </div>
