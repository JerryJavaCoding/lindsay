								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
                                                ...
                                                <div class="inter">
                                                    ...
                                                    <div class="col-md-12">
                                                     ...
                                                     <div class="col-md-12">
                                                        ...
                                                        <input type="text" placeholder="male or female" class="form-control" id="tsex" name="translator.tsex">
                                                    </div>
                                                     <div class="col-md-12">
                                                     ...
                                                     <div class="col-md-12">
                                                        ...
                                                        <input type="text" placeholder="the language you're good at" class="form-control" id="tlanguage" name="translator.tlanguage">
                                                    </div>
                                                     <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12 mgt10" >
                                                        <input type="submit" class="btn btn-primary" id="tsign" value="Sign up">
                                                    </div>
                                             </form>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" placeholder="male or female" class="form-control" id="fsex" name="foreigner.fsex">
                                                    </div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" placeholder="the country you're from" class="form-control" id="fcountry" name="foreigner.fcountry">
                                                    </div>
                                                    <div class="col-md-12">
                                                ...
                                                <div class="col-md-12 mgt10" >
                                                        <input type="submit" class="btn btn-primary" id="fsign" value="Sign up">
                                                 </div>
